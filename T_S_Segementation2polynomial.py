...
#==============Seg2Poly==========
def Seg2poly(fileName,wd_length,polyOrd,limit_diff,limit_r2,polyIndex,limit_interval_percent):
    startPt=0
    endPt=0
    delta=0
    '''
...
# =============================================================================
    ...
    tolMeanFile='Data_csv\\SlidingWindow\\Mean\\SWAllMean.csv'
